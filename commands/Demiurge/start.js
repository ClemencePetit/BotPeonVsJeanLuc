    ...
    execute(DemiurgeBot, message, arguments) {
        ...
        if (!PVSJL.running) {
            ...
            if (message.member.roles.cache.some(r => r.name === "Demiurge")) {
                ...
                Utils.PrintStringToAllChannels(DemiurgeBot, "Je vous prierai d'être poli et de commencer toutes vos phrases par **!** qui veut dire *s'il vous plait* en théoludique. Merci.");
